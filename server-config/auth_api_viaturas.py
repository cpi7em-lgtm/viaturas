...
async def login_soap(body: LoginBody):
    """Login via SOAP CPD PM. Cria usuario viewer no Convex Viaturas se primeiro acesso."""
    ...
    print(f"[viaturas-auth] convex_user_id: {convex_user_id} unit: {convex_unit_id}")
