 ...
 */
export async function renderWebApplication(apiConfig, applicationConfig) {
    ...
    const { port, open, onListen, onOpenError, visualization, watch } = applicationConfig;
 ...
 * that will be rendered.
 */
export async function renderStandaloneWebApplication(fromInstance, applicationConfig) {
    const { port, open, onListen, onOpenError, visualization, watch } = applicationConfig;
    const { app, listen } = createHttpApp(port);
