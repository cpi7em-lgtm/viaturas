...
export class DiGraph {
    ...
    *breadthFirstTraversalFrom(rootVertexId, visitedVerticesIds = new Set()) {
        const vertex = __classPrivateFieldGet(this, _DiGraph_vertices, "f").get(rootVertexId);
        if (!vertex)
            return;
        ...
        for (const vertexId of vertex.adjacentTo) {
            const adjacentVertex = __classPrivateFieldGet(this, _DiGraph_vertices, "f").get(vertexId);
    ...
    *traverseAll(traversal) {
        ...
        for (const vertexId of __classPrivateFieldGet(this, _DiGraph_vertices, "f").keys()) {
            if (traversal === "dfs") {
