...
function resolveIgnore(content, dir) {
...
export async function loadIgnoreConfig(configPath, resolver) {
...
export async function createConfig(config, { configPath, externalRefResolver, ignore } = {}) {
