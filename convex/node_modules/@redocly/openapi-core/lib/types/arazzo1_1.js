...
const AsyncAPISourceDescription = {
    properties: {
        name: {
            type: 'string',
...
const expressionTypeResolver = (value) => {
...
const expressionTypeOrEnumResolver = (enumValues, description, { optional = true } = {}) => (value) => {
    if (optional && !value) {
        return undefined;
    }
...
//# sourceMappingURL=arazzo1_1.js.map